...
<section class="container auth-sec">
    ...
    <div class="auth-block">
        ...
        <form class="card-body pt-3 mt-5" id="login" name="login" action="{{ route('player-registration') }}" method="GET">
            {{-- @csrf --}}
            {{-- Email --}}
            ...
            <div class="d-flex justify-content-center">
                <a href="{{ route('player-registration') }}"><input type="submit" class="submit-btn mt-0" value="Continue"></a>
            </div>
        </form>
    </div>
