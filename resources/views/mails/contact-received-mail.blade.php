                                        ...
                                        <tr>
                                           <td class="pad" style="vertical-align: middle; color: #000000; font-family: inherit; font-size: 14px; text-align: center; padding-top: 60px;">
                                              <table align="center" cellpadding="0" cellspacing="0" class="alignment" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                                 <tr>
                                                    <td style="vertical-align: middle; text-align: center; padding-top: 5px; padding-bottom: 5px; padding-left: 10px; padding-right: 10px;"><a title="Facebook"href="https://www.facebook.com/the.playerscorner/" style="text-decoration: none;" target="_blank"><img align="center" alt="" class="icon" height="32" src="{{ $message->embed('assets/images/mail-icons/fb-i.png') }}" style="display: block; height: auto; margin: 0 auto; border: 0;" width="32"/></a></td>
                                                    <td style="vertical-align: middle; text-align: center; padding-top: 5px; padding-bottom: 5px; padding-left: 10px; padding-right: 10px;"><a title="Instagram"href="https://www.instagram.com/the.playerscorner" style="text-decoration: none;" target="_blank"><img align="center" alt="" class="icon" height="32" src="{{ $message->embed('assets/images/mail-icons/insta-i.png') }}" style="display: block; height: auto; margin: 0 auto; border: 0;" width="32"/></a></td>
                                                    <td style="vertical-align: middle; text-align: center; padding-top: 5px; padding-bottom: 5px; padding-left: 10px; padding-right: 10px;"><a title="linkedin"href="https://www.linkedin.com/company/the-players-corner" style="text-decoration: none;" target="_blank"><img align="center" alt="" class="icon" height="32" src="{{ $message->embed('assets/images/mail-icons/linkedin-i.png') }}" style="display: block; height: auto; margin: 0 auto; border: 0;" width="32"/></a></td>
                                                    <td style="vertical-align: middle; text-align: center; padding-top: 5px; padding-bottom: 5px; padding-left: 10px; padding-right: 10px;"><a title="twitter"href="https://www.twitter.com/thepc_official" style="text-decoration: none;" target="_blank"><img align="center" alt="" class="icon" height="32" src="{{ $message->embed('assets/images/mail-icons/twitter-i.png') }}" style="display: block; height: auto; margin: 0 auto; border: 0;" width="39"/></a></td>
                                              ...
                                              <table align="left" cellpadding="0" cellspacing="0" class="alignment" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                                 <tr>
                                                    <td style="vertical-align: middle; display: flex; align-items: center; text-align: center; padding-top: 5px; padding-bottom: 5px; padding-left: 5px; padding-right: 5px;">
                                                      <img align="center" alt="" class="icon" height="64" src="{{ $message->embed('assets/images/logo-1.png') }}" style="display: block; height: auto; margin: 0 auto; border: 0;" width="64"/>
                                                      <b style="font-family:Open Sans, Helvetica Neue, Helvetica, Arial, sans-serif; font-size: 16px;">The Players Corner</b>
                                                  </td>
                                                 </tr>
                                              </table>
                                           </td>
