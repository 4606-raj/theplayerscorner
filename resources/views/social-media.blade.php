...
@section('content')
    ...
    <p class="ct-hdr-2 mt-4 mb-4"><b>Follow the Athletic on social media</b></p>
     ...
     <section class="container">
        <div class="embedsocial-hashtag" data-ref="067e43e5ca1b6086045f36fa00388be21c20fbea"></div> <script> (function(d, s, id) { var js; if (d.getElementById(id)) {return;} js = d.createElement(s); js.id = id; js.src = "https://embedsocial.com/cdn/ht.js"; d.getElementsByTagName("head")[0].appendChild(js); }(document, "script", "EmbedSocialHashtagScript")); </script>
        <div class="embedsocial-hashtag" data-ref="fe2ad9b8192591c9f2c6d3053e3595a8f2c8fff9"></div> <script> (function(d, s, id) { var js; if (d.getElementById(id)) {return;} js = d.createElement(s); js.id = id; js.src = "https://embedsocial.com/cdn/ht.js"; d.getElementsByTagName("head")[0].appendChild(js); }(document, "script", "EmbedSocialHashtagScript")); </script>
...
{{-- <div class="sponsorship-wrapper">p
