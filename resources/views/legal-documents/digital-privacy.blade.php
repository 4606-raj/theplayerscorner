...
<section class="container" id="lg-container">
    ...
    <div class="brief-box">
        <b>In brief…</b><a href="company_details.html">The Club</a> for which the website is branded. Details of our Data Protection Officer(s) can be found <a href="privacy_policy.html">here</a>.
    </div>
    
    <p class="lg-des-txt">Southall Athletic FC, its partners, suppliers, sponsors, and volunteers operate the Online Facilities on behalf of <a href="company_details.html">The Club</a>. When this policy states “The Club” we are referring to Southall Athletic FC, its partners, suppliers, sponsors, and volunteers. The Club may use your data on the basis set out in this Policy. </p>
    <p class="lg-des-txt">References to <b>“we”</b>, <b>“us”</b> and <b>“our”</b> in this Policy are all references to The Club.</p>
    <p class="lg-des-txt">Click for company information about <a href="company_details.html">The Club</a> and our <a href="privacy_policy.html#redirect-1">Data Protection Officer(s)</a>.</p>
    ...
    <p class="lg-des-txt">For further information about how The Club uses your data in these circumstances, please <a href="contact_us.html">contact the Club</a>.</p>
