    ...
    <div class="container">
        <div class="row align-items-center flex-row-reverse">
            <div class="col-md-12 col-sm-12 mt-3 mt-lg-0 text-center">
                Copyright © 2024. Designed by <a href="https://stage.theplayerscorner.co.uk">The Players Corner</a> All rights reserved.
            </div>
        </div>
    </div>
</footer>
...
{{-- <script src="{{ asset('assets/admin/plugins/apexchart/apexcharts.js') }}"></script> --}}

<!-- INTERNAL Vertical-scroll js-->
{{-- <script src="{{ asset('assets/admin/plugins/vertical-scroll/jquery.bootstrap.newsbox.js') }}"></script> --}}
<script src="{{ asset('assets/admin/plugins/vertical-scroll/vertical-scroll.js') }}"></script>
...
{{-- <script src="{{ asset('assets/admin/plugins/chart.min/chart.min.js') }}"></script> --}}
{{-- <script src="{{ asset('assets/admin/plugins/chart.min/rounded-barchart.js') }}"></script> --}}

<!-- INTERNAL jQuery-countdowntimer js -->
{{-- <script src="{{ asset('assets/admin/plugins/jQuery-countdowntimer/jQuery.countdownTimer.js') }}"></script> --}}
